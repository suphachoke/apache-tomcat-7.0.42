 ...
 * Generated at: 2015-11-18 06:41:06 UTC
...
public final class submitService_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
        ...
        if (request.getParameter("sparql") != null) {
            ...
            if (request.getParameter("action").equals("add")) {
                try {
                    ...
                    stmt.executeUpdate("insert into namespace (uri) values ('" + request.getParameter("ns") + "')");
                } catch (Exception e) {
                    //e.printStackTrace();
                }
            } else {
                redirect = "dataRecords.jsp?ontons=" + URLEncoder.encode(request.getParameter("ontons"));
            }

            int loop = (request.getParameter("loop") != null) ? Integer.parseInt(request.getParameter("loop")) : 1;
      ...
      out.write("                </div>\n");
      out.write("            </div>\n");
      out.write("            <a class=\"btn btn-sm btn-success\" href=\"javascript:void(0);\" onclick=\"window.location.href='");
      out.print(redirect);
      out.write("';\">Back</a>\n");
      out.write("        </div>\n");
      out.write("    </body>\n");
